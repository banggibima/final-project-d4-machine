...
MODEL_PATH = './models_v1/unet_model_v002_best.keras'
INPUT_SHAPE = (640, 640)
OUTPUT_DIR = './outputs_v1/predict'
...
async def predict(file: UploadFile = File(...), ocr_engine: str = Query("tesseract", enum=["tesseract", "easyocr"])):
    ...
    inverted_mask = 255 - mask_original_size
    inverted_mask_base64 = mask_to_base64(inverted_mask)
    ...
    return JSONResponse({
        ...
        "inverted_mask_base64": inverted_mask_base64,
    })

if __name__ == "__main__":
    uvicorn.run("main_v1:app", host="0.0.0.0", port=8000)
